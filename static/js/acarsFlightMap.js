...
golgotha.maps.acarsFlight.showRunway = function(rd) {
	let pl = new google.maps.Polyline({map:map, path:[rd.location,rd.pt], strokeWeight:3.5, strokeColor:'#0000a1', strokeOpacity:0.5, zIndex:golgotha.maps.z.POLYLINE+1});
	return true;
};
